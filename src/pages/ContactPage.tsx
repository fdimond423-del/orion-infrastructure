              ...
              <div>
                ...
                <div className="p-8 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4 relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-3 mt-4 text-slate-600 text-sm">
                    ...
                    <a href="tel:+12722679492" className="font-semibold hover:text-blue-600 transition-colors">Help desk - +1 272-267-9492 (USA)</a>
                  </div>
                  <div className="flex items-center gap-3 mt-4 text-slate-600 text-sm">
                ...
                <div className="p-8 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4 relative overflow-hidden mt-6">
                  ...
                  <div className="pb-2">
                    <h3 className="text-lg font-bold text-slate-900">Mayur Gadhvi</h3>
                    <p className="text-xs font-semibold text-slate-500 uppercase mt-1">(Marketing pro) Real estate agent</p>
