      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-6 font-sans">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col"
          ...
          >
            ...
            <button 
              onClick={(e) => { e.stopPropagation(); setIsOpen(false); }}
              className="absolute top-6 right-6 p-3 bg-slate-100 hover:bg-slate-200 rounded-full text-slate-700 transition-colors z-[100] shadow-sm cursor-pointer"
            >
              <X className="w-6 h-6" />
            </button>

            <div className="p-10 md:p-14 relative z-10 flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-600 mb-8 shadow-sm border border-blue-100">
              ...
              <p className="text-slate-600 leading-relaxed mb-12 text-base md:text-lg lg:text-xl max-w-3xl">
              ...
              <div className="w-full max-w-3xl bg-slate-50 rounded-2xl p-8 border border-slate-100">
                <p className="text-base md:text-lg font-semibold text-slate-800 flex flex-col sm:flex-row items-center justify-center gap-3 uppercase tracking-wide text-center">
              ...
              <button 
                onClick={(e) => { e.stopPropagation(); setIsOpen(false); }}
                className="mt-10 px-10 py-4 text-lg bg-slate-900 text-white rounded-full font-semibold hover:bg-slate-800 transition-colors hover:shadow-xl w-full sm:w-auto cursor-pointer"
              >
