      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-6 font-sans">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden"
          ...
          >
            ...
            <button 
              onClick={(e) => { e.stopPropagation(); setIsOpen(false); }}
              className="absolute top-4 sm:top-5 right-4 sm:right-5 p-2 bg-slate-100 hover:bg-slate-200 rounded-full text-slate-700 transition-colors z-[100] shadow-sm cursor-pointer"
            >
              <X className="w-5 h-5 sm:w-6 sm:h-6" />
            </button>

            <div className="p-6 sm:p-8 md:p-10 relative z-10 flex flex-col items-center text-center">
              ...
              <p className="text-slate-600 leading-relaxed mb-6 sm:mb-8 text-sm sm:text-base md:text-lg max-w-2xl">
              ...
              <div className="w-full max-w-2xl bg-slate-50 rounded-2xl p-5 sm:p-6 border border-slate-100">
                <p className="text-sm sm:text-base font-semibold text-slate-800 flex flex-col sm:flex-row items-center justify-center gap-2 uppercase tracking-wide text-center">
              ...
              <button 
                onClick={(e) => { e.stopPropagation(); setIsOpen(false); }}
                className="mt-6 sm:mt-8 px-8 sm:px-10 py-3 sm:py-4 text-base sm:text-lg bg-slate-900 text-white rounded-full font-semibold hover:bg-slate-800 transition-colors hover:shadow-xl w-full sm:w-auto cursor-pointer"
              >
